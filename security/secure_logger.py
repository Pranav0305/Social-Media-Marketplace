...
LOG_FILE = os.path.abspath(os.path.join(LOG_DIR, "secure_log.txt"))
        ...
        for line_num, line in enumerate(file, 1):
            try:
                ...
                if computed_hash.strip() != stored_hash.strip():
                    tampered_logs.append((line_num, log_data.strip()))
            except ValueError:
                tampered_logs.append((line_num, "[Malformed Entry] " + line.strip()))
